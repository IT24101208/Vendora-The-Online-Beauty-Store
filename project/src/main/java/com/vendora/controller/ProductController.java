package com.cosmetic.app.controller;

import com.cosmetic.app.dto.ProductDto;
import com.cosmetic.app.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<ProductDto.Response> updateProduct(
        ...
        return ResponseEntity.ok(productService.updateProduct(
            id, name, brand, sku, barcode, category, description, ingredients, usageInstructions,
            price, costPrice, stockQuantity, lowStockThreshold, unit, shade, skinType, volume,
            supplierName, supplierContact, supplierEmail, supplierAddress,
