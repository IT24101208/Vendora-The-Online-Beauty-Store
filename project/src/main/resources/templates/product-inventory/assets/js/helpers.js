...
export const CATEGORIES = ['SKINCARE','MAKEUP','HAIRCARE','FRAGRANCE','BODYCARE','NAILCARE','SUNCARE','MENCARE','BABYCARE','WELLNESS'];
export const CATEGORY_LABELS = {
  SKINCARE:'🧴 Skincare', MAKEUP:'💄 Makeup', HAIRCARE:'💆 Haircare', FRAGRANCE:'🌸 Fragrance',
  BODYCARE:'🛁 Body Care', NAILCARE:'💅 Nail Care', SUNCARE:'☀️ Sun Care', MENCARE:'🧔 Men\'s Care',
  BABYCARE:'🍼 Baby Care', WELLNESS:'🌿 Wellness'
};
